                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Alert & notifications<small></small></h1>
                                <ol class="breadcrumb">
                                    <li><a href="#"><i class="fa fa-home"></i></a></li>
                                    <li class="active">Alert & notifications</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- end .page title-->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="panel panel-card recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">  Bootstrap alerts</h4>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-card recent-activites">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">  Bootstrap dismiss alerts</h4>
                                    <div class="panel-actions">
                                        <a href="#" class="panel-action panel-action-toggle" data-panel-toggle></a>
                                        <a href="#" class="panel-action panel-action-dismiss" data-panel-dismiss></a>
                                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="panel panel-card recent-activites">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="sweet-buttons">
                                        <button class="simple-alert btn btn-primary btn-lg btn-sweet-alert">Simple Alert</button>
                                        <button class="timer-alert btn btn-primary btn-lg btn-sweet-alert">Timer Alert</button>
                                        <button class="success-alert btn btn-primary btn-lg btn-sweet-alert">success Alert</button>
                                        <button class="warning-alert btn btn-primary btn-lg btn-sweet-alert">Warning Alert</button>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-card recent-activites">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">  tooltips & popovers</h4>
                                    <div class="panel-actions">
                                        <a href="#" class="panel-action panel-action-toggle" data-panel-toggle></a>
                                        <a href="#" class="panel-action panel-action-dismiss" data-panel-dismiss></a>
                                    </div>
