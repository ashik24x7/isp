                            ...
                            <div class="order-view-box">
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="label label-info">Shipped</div>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                 <strong>128 Mahadev Nagar, Vaishali</strong>
                              </div>
                           </div>
                           <div class="form-group">
