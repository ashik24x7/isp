...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Inline Editing <small></small></h1>
                                <ol class="breadcrumb">
                                    <li><a href="#"><i class="fa fa-home"></i></a></li>
                                    <li class="active">Inline Editing</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- end .page title-->
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel-card">
                                <div class="panel-heading">Editable inputs</div>
                                <table id="user" style="clear: both" class="table table-bordered table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a id="group" href="#" data-type="select" data-pk="1" data-value="5" data-source="../server/xeditable-groups.json" data-title="Select group">Admin</a>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="panel-card">
                                <div class="panel-heading">Editable table</div>
        ...
        <!-- DEMO-->
        <script src="js/custom-editable.js"></script>
        <!-- Google Analytics:  -->
        <script>
